...
if [ -r /etc/ppp/link ];then
	...
	if [ $WAN_DHCP = 4 ] || [ $WAN_DHCP = 8 ] || [ $WAN_DHCP = 6 ] || [ $WAN_DHCP = 9 ] || [ $WAN_DHCP = 10 ] || [ $WAN_DHCP = 11 ] || [ $WAN_DHCP = 12 ] || [ $WAN_DHCP = 13 ] || [ $WAN_DHCP = 19 ] || [ $WAN_DHCP = 18 ] ; then
		if [ $WAN_DHCP = 12 ] || [ $WAN_DHCP = 13 ] || [ $WAN_DHCP = 19 ] || [ $WAN_DHCP = 18 ];then
